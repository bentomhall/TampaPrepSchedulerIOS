...
import XCTest
import CoreData
import TerpScheduler

class TerpSchedulerTests: XCTestCase {
...
/*
    func testScheduleLoader(){
        let context = self.managedObjectContext!
        var sl = SemesterScheduleLoader(context: context)
        let managedObjects = sl.LoadScheduleDataFromJSON()
        println(managedObjects[0])
        XCTAssertNotEqual(managedObjects.count, 0, "Need more than one object created")
    }
  */  
}
