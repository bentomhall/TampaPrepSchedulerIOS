  ...
  func saveData() {
    if titleField!.text != "" {
      ...
      if completion {
        ...
        let newTaskData = DailyTask(date: date!, period: period!, shortTitle: shortTitle!, details: details!, isHaiku: isHaiku, completion: completion, priority: priority!, notify: notification, guid: UUID().uuidString)
